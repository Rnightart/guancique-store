 ...
 * ---------------------------------------------------------------------- */
const PRODUCTS = [
  { id: "kc-001", name: "Sakura Chibi Anime Keychain", category: "Anime", price: 8.99, oldPrice: null, rating: 4.8, reviews: 214, badge: "best", image: "https://placehold.co/600x600/DBEAFE/2563EB?text=Anime+Keychain", colors: ["#2563EB", "#F97316", "#111827"], description: "A soft-enamel chibi charm inspired by classic anime heroines. Hand-painted details and a durable brass ring make this a favorite among collectors and cosplayers alike." },
  { id: "kc-002", name: "Pixel Gamepad Keychain", category: "Gaming", price: 7.49, oldPrice: 9.99, rating: 4.6, reviews: 158, badge: "sale", image: "https://placehold.co/600x600/E0E7FF/2563EB?text=Gamepad+Keychain", colors: ["#2563EB", "#111827"], description: "A retro pixel-art gamepad charm cast in acrylic. Perfect for gamers who want a nostalgic nod to 8-bit consoles on their keys or backpack." },
  { id: "kc-003", name: "Custom Name Acrylic Keychain", category: "Custom Name", price: 11.99, oldPrice: null, rating: 4.9, reviews: 342, badge: "best", image: "https://placehold.co/600x600/FFEDD5/F97316?text=Custom+Name", colors: ["#F97316", "#2563EB", "#111827"], description: "Personalize a keychain with any name or short phrase, laser-engraved into premium acrylic. A thoughtful, made-to-order gift for any occasion." },
  { id: "kc-004", name: "Matching Couple Heart Keychains", category: "Couple", price: 14.99, oldPrice: 18.99, rating: 4.7, reviews: 189, badge: "sale", image: "https://placehold.co/600x600/FCE7F3/DB2777?text=Couple+Set", colors: ["#F97316", "#111827"], description: "A set of two interlocking heart charms, sold together, so you and someone special can carry a piece of each other every day." },
  { id: "kc-005", name: "Retro Classic Car Keychain", category: "Cars", price: 9.99, oldPrice: null, rating: 4.5, reviews: 96, badge: "new", image: "https://placehold.co/600x600/DCFCE7/16A34A?text=Classic+Car", colors: ["#111827", "#2563EB"], description: "A miniature die-cast style classic car silhouette, finished with a satin metal coat. Built for drivers who like their keys to match their garage." },
  { id: "kc-006", name: "Chopper Motorcycle Keychain", category: "Motorcycles", price: 10.49, oldPrice: null, rating: 4.6, reviews: 74, badge: null, image: "https://placehold.co/600x600/FEF3C7/D97706?text=Motorcycle", colors: ["#111827", "#F97316"], description: "A bold chopper-style motorcycle charm in brushed metal, designed for riders who want their keys to look as sharp as their bike." },
